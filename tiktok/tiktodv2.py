...
vidUrl = "https://vt.tiktok.com/ZSfuPsnY/" #Change YOUR_URL to your Tik Tok video URL
username = "bukanazizgagap" #Change YOUR_USERNAME to your Tik Tok username
...
auto = 5700 #Change 2 for Tik Tok views
if auto == 1:
    loop1()
else:
    loop2()
